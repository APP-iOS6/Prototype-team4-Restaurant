...
class ChoiceFoodViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        layout.itemSize = CGSize(width: 100, height: 50) // Adjust width for padding
